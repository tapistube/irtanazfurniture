...
$idsap = $this->session->userdata('idsapi');
//echo $idsap['id_sapi'];
?>
<div id="page-wrapper">
    ...
    <div class="row">
        <!-- Page Header -->
        <div class="col-lg-12">
            <h1 class="page-header">Upload Data Sapi</h1>
        </div>
        <!--End Page Header -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <br>
                    <label class="control-label" for="dropzone">Upload Foto Sapi</label>
                    <div class="dropzone">
                        <div class="dz-message">
                            <h3> Klik atau Drop Foto Sapi disini</h3>
                        </div>
                    </div>
                    <br>

                    <?php echo form_open_multipart('Admin/listSapi'); ?>
        ...
        <script type="text/javascript">
            ...
            //hati2 di line ini
            var kode_sapi = "<?php echo $idsap['id_sapi'];?>";
