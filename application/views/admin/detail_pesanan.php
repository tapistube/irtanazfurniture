...
<div class="row">
    ...
    ?>
    <div class="col-md-12">
        <h3>Pesanan Tanggal : <?php cetak($tanggal_beli);?></h3>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    ...
                    <div align="center" class="col-md-6">
                        <a onclick="return confirm('Are you sure ?')" href="<?php echo base_url();?>Admin/verifikasiDP/<?php cetak($id_faktur); ?>"
                           class="btn btn-warning btn-lg" >Verifikasi Pembayaran DP</a>
                    </div>

                    <div align="center" class="col-md-6">
                        <a onclick="return confirm('Are you sure ?')" href="<?php echo base_url();?>Admin/verifikasiLunas/<?php cetak($id_faktur); ?>"
                           class="btn btn-success btn-lg" >Verifikasi Pembayaran Lunas</a>
                    </div>
