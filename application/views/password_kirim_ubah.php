...
<head>
   ...
   <!-- <link rel="stylesheet" href="<?php echo base_url();?>assets1/css/styleInvoice.css" media="all" /> -->
    ...
    <?php foreach ($dataku as $a) {
        $nama_custom = $a->nama_customer;
        $alamat_custom = $a->alamat_customer;
        $user_name = $a->user_name;
        $password = $this->encrypt->decode($a->password);
    } ?>
...
<main>
    <div id="details" class="clearfix">
        <div id="client">
            ...
            <h2 class="name"><?php echo $nama_custom; ?></h2>
            <div class="address"><?php echo $alamat_custom; ?></div>
        </div>
        <div id="invoice">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="total"><?php echo $password_ubahan; ?></td>
        </tr>
        </tbody>
        <tfoot>
        </tfoot>
